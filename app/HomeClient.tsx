    ...
    const result = activePosts.filter((post) => {
      if (filters.query) {
        const searchable = [
          ...
          post.district,
          post.propertyType,
          post.listingType === "rent" ? "kiadó kiado" : "eladó elado",
          post.condition,
          post.parking,
          post.balcony,
          post.heating,
      ...
      if (filters.listingType && post.listingType !== filters.listingType) return false;
